...
class GigsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post gigs_url, params: { gig: { agent_id: @gig.agent_id, description: @gig.description, industry: @gig.industry, title: @gig.title, user_id: @gig.user_id } }
    end
  ...
  test "should update gig" do
    patch gig_url(@gig), params: { gig: { agent_id: @gig.agent_id, description: @gig.description, industry: @gig.industry, title: @gig.title, user_id: @gig.user_id } }
